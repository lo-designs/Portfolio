...
const neurotypeData = {
  ...
  overview: [
    <>While at Prime, I was on a team that had the privilege of working with<b><a href="https://neurotype.io" target="_blank" rel="noopener noreferrer" className="bold-link"> Neurotype Inc.</a></b>, a company building portable brain sensing tools to support the recovery of people struggling with Opioid Use Disorder [OUD].</>,
    "Our task was to help determine the best way to integrate a portable electroencephalogram [EEG] into a standard therapy/clinical setting, as well as create a prototype for NeuromarkR™, an application that displays EEG measurements."
  ],
  tabs: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The information from interviews with healthcare professionals helped us gain a better idea of how a portable EEG could be implemented in a standard therapy session. This allowed us to create an experience map to visualize what the process might look like."
      ]
    },
      {
