...
const soonaData = {
  heroImage: soonaHero,
  title: "Soona",
  projectType: "24 HR Content Studio // UX UI",
  ...
  tabs: [
    ...
    
    {
      ...
      descriptionTitle: "03 Developer's time budget",
      paragraphs: [
    ...
    },
    {
      ...
      descriptionTitle: "",
      paragraphs: [
        "Simple features were suggested to make the booking & building a shoot process easy to follow. Thesefeatures included: a progress bar, quick view options, awork-in-progress pop-up message, and a style guide."
      ]
    }
  ]
};
