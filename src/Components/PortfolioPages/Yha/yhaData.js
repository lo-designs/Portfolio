...
const yhaData = {
  ...
  tabs: [
    ...
    },
    {
      ...
      paragraphs: [
        "The interviews, research, and analysis of YSN helped me determine features for the app: easy to access contact info, scannable information, direct call and email links. Additionally, I wanted to implement a way to narrow down resources to find those that best fit the needs of the person using the app. To help with conceptualize the app, I created a proto-persona, an experience map, a user flow, and wireframes using Sketch and Adobe XD.",
      ],
    },
    {
      label: "Prototyping",
      image: yhaPrototype,
      imageCaption: "[ Prototype mockups: made in Figma ]",
